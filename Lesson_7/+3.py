...
class Cell:
    ...
    def __add__(self, other):
        return f"Результат сложения: {self.cell_count + other.cell_count}"

    def __sub__(self, other):
        if (self.cell_count - other.cell_count) > 0:
            return f"Результат вычитания: {self.cell_count - other.cell_count}"
        elif (self.cell_count - other.cell_count) == 0:
            return f"Количество клеток в объектах одинаковое"
        else:
            return f"Результат вычитания: {other.cell_count - self.cell_count}"

    def __mul__(self, other):
        return f"Результат умножения: {self.cell_count * other.cell_count}"
